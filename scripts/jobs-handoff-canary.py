...
def _run_canary(modules, work: Path, manifest: Mapping[str, object]) -> dict:
    ...
    try:
        ...
        _edge(
            ...
            attempt_id=retry,
            source="VERIFIED",
            target="OUTCOME_VERIFYING",
            speaker_id="outcome-1",
            speaker_role="outcome-verifier",
            outcome="handed_off",
            at=225,
            next_owner="outcome-verifier",
            summary="Outcome verifier started the critical user journey.",
            next_action="Record independently observed behavior.",
            required=("outcome_contract",),
        )
        _edge(
            modules,
            conn,
            ...
            job_id=job_id,
            attempt_id=retry,
            source="OUTCOME_VERIFYING",
            target="OUTCOME_VERIFIED",
            speaker_id="outcome-1",
            speaker_role="outcome-verifier",
            outcome="passed",
            at=228,
            next_owner="builder",
            summary="Outcome verifier proved the critical user journey.",
            next_action="Complete the Job.",
            required=("critical_journey_result",),
        )
        _edge(
            modules,
            conn,
            ...
            required=("activation_gate", "completion_receipt", "knowledge_closure"),

...
def test_full_handoff_conversation_is_substantive_and_exact_origin(
    ...
    try:
        ...
        _record(
            ...
            outcome="handed_off",
            at=225,
            summary="Outcome verification started for the corrected card.",
            next_action="Confirm the critical user journey.",
        )
        _record(
            conn,
            key,
            ...
            outcome="passed",
            at=228,
            summary="The corrected card passed its critical user journey.",
            next_action="Complete the Job.",
        )
        _record(
            conn,

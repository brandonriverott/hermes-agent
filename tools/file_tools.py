...
SEARCH_FILES_SCHEMA = {
    ...
    "parameters": {
        ...
        "properties": {
            ...
            "include_tcc_paths": {"type": "boolean", "description": "macOS only: include TCC-protected app-data paths that broad searches omit by default (Containers, Group Containers, Mail, Messages, Calendars, Reminders, Mobile Documents, CloudStorage, and Photos Library). Use only when the user explicitly wants those locations searched and understands macOS may prompt for access.", "default": False}
        },
        "required": ["pattern"]
    }
}
...
def _handle_search_files(args, **kw):
    ...
    return search_tool(
        ...
        include_tcc_paths=bool(args.get("include_tcc_paths", False)), task_id=tid)
